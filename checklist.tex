...
\item \textbf{Claims.} \answerYes{} The abstract and introduction state that \method\ is an exact package-oracle evaluation protocol for finite memory-writing packages, not a deployed memory architecture. The scope and package-conditional nature are discussed in \Cref{sec:scope}.
